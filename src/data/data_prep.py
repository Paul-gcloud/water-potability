...
def main():
    try:
        ...
        save_data(processed_train_data, os.path.join(processed_data_path, 'train_processed.csv'))
        save_data(processed_test_data, os.path.join(processed_data_path, 'test_processed.csv'))
    except Exception as e:
